/*
 * Récupération des informations contenues dans le sessionStorage.
 */
var monObjet = (sessionStorage.getItem("formContact"));
var totalAvecLivraison = sessionStorage.getItem("totalAvecLivraison");
/*
 * Envoi d'une requête à l'API pour obtenir un ID de commande
 * Construction de l'objet maCommande avec les informations à afficher
 */
...
req.onload = function () {
    ...
    /*
     * Insertion des informations correspondantes au panier et au formulaire
     */
